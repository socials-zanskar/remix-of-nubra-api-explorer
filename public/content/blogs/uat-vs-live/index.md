...
<div class="uat-compare-container">
  ...
  <div class="uat-column">
    ...
    <div class="uat-gif-wrap">
      <figure class="gif-card">
        <img src="./assets/PROD.gif" alt="LIVE order book behavior"/>
      </figure>
    </div>
  ...
  <div class="uat-column">
    ...
    <div class="uat-gif-wrap">
      <figure class="gif-card">
        <img src="./assets/UAT.gif" alt="UAT simulated order book"/>
      </figure>
    </div>
...
<div class="uat-guide">
  ...
  <div class="intro-split">
    ...
    <div class="intro-image">
      <img src="./assets/UATEnvironment.png" alt="UAT vs LIVE overview"/>
    </div>
...
<div class="uat-feature-grid">
  ...
  <div class="uat-feature-card">
    <div class="uat-feature-icon">
      <img src="./assets/Shield.png" alt="Zero Risk" />
    </div>
  ...
  <div class="uat-feature-card">
    <div class="uat-feature-icon">
      <img src="./assets/FakeMoney.png" alt="Zero Risk" />
    </div>
  ...
  <div class="uat-feature-card">
    <div class="uat-feature-icon">
      <img src="./assets/Lightning.png" alt="Zero Risk" />
    </div>
  ...
  <div class="uat-feature-card">
    <div class="uat-feature-icon">
      <img src="./assets/Dashboard.png" alt="Zero Risk" />
    </div>
